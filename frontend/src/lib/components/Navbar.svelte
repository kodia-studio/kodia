...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 shadow-md hover:shadow-lg {scrolled ? 'py-3' : 'py-4'}">
    <div class="container mx-auto px-6 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="/state-management-demo" class="text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-primary transition-colors">Data Layer</a>
                ...
                <a href="https://github.com/kodia-studio/kodia" target="_blank" class="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800" aria-label="GitHub">
            ...
            <button class="md:hidden p-2 text-slate-600 dark:text-slate-400 hover:text-primary transition-colors rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800" aria-label="Toggle Menu">
                <Menu size={24} />
            </button>
    </div>
</nav>
