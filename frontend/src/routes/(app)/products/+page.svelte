...
<div class="space-y-6">
	<div class="flex items-center justify-between">
		<div>
			<h1 class="text-2xl font-bold tracking-tight">products Management</h1>
			<p class="text-slate-500 dark:text-slate-400">View and manage your productss.</p>
		</div>
				...
				<tbody class="divide-y divide-slate-200 dark:divide-slate-700">
					...
					<tr>
						<td colspan="4" class="px-6 py-8 text-center text-slate-500">
							No productss found. Get started by creating a new one.
						</td>
					</tr>
				</tbody>
			</table>
